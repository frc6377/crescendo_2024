...
public class PhotonSubsystem extends SubsystemBase implements VisionSubsystem {
    ...
    public PhotonSubsystem(BiConsumer<Pose2d, Double> measurementConsumer) {
        ...
        poseEstimator = new PhotonPoseEstimator(aprilTagFieldLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, camera, new Transform3d(new Translation3d(0,0,0), new Rotation3d(0,Constants.TurretConstants.LIMELIGHT_PITCH_RADIANS,Units.degreesToRadians(180))));
    }
    ...
    public Pose2d getPose2d() {
        ...
        return new Pose2d(estimatedPose.getX(), estimatedPose.getY(), new Rotation2d(estimatedPose.getRotation().getZ()));
    }
