...
public class ShooterCommandFactory {
  ...
  private GenericEntry targetRPM = shooterTab.add("Target RPM", 3431.25).getEntry();
  private GenericEntry rightTargetRPM = shooterTab.add("right RPM", 2531.25).getEntry();
